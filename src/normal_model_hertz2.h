...
#ifdef NORMAL_MODEL
NORMAL_MODEL(HERTZ2,hertz2,5)
#else
#ifndef NORMAL_MODEL_HERTZ2_H_
#define NORMAL_MODEL_HERTZ2_H_
...
namespace ContactModels
{
  ...
  template<>
  class NormalModel<HERTZ2> : public NormalModelBase
  {
  public:
    ...
    void registerSettings(Settings & settings)
    {
      ...
      settings.registerOnOff("heating_normal_hertz2",heating,false);
    ...
    void connectToProperties(PropertyRegistry & registry)
    {
      ...
      registry.registerProperty("Yeff", &MODEL_PARAMS::createYeff,"model hertz2");
      registry.registerProperty("Geff", &MODEL_PARAMS::createGeff,"model hertz2");
      registry.registerProperty("betaeff", &MODEL_PARAMS::createBetaEff,"model hertz2");

      registry.connect("Yeff", Yeff,"model hertz2");
      registry.connect("Geff", Geff,"model hertz2");
      registry.connect("betaeff", betaeff,"model hertz2");
    ...
    void surfacesIntersect(SurfacesIntersectData & sidata, ForceData & i_forces, ForceData & j_forces)
    {
      ...
      double kn=1.*Yeff[itype][jtype]*sqrtval;
      double kt=St;
      ...
      if(!displayedSettings)
      {
        ...
        /*
        if(limitForce)
            if(0 == comm->me) fprintf(screen," NormalModel<HERTZ2_STIFFNESS>: will limit normal force.\n");
        */
      }
