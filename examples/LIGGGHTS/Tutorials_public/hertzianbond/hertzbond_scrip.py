...
variable maxsigma equal 25.75e3
variable maxtange equal 10.1e3

#Material properties required for new pair styles

fix 		m1 all property/global youngsModulus peratomtype 0.45e6 0.45e6 0.45e6 0.45e6 0.45e6
...
variable curr_r1 equal ${r1_init}+step*${growscalar}*0.5 #fix control about diameter information 
