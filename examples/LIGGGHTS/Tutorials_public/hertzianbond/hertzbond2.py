...
variable nstiffness equal 11.5e3
variable tstiffness equal 11.5e1
variable maxsigma equal 30.75e5
variable maxtange equal 1.5e3

variable dampingnormalForce equal 0.98
variable dampingtangentForce equal 0.98
variable dampingnormalTorque equal 0.98
variable dampingtangentTorque equal 0.98
#Material properties required for new pair styles

fix 		m1 all property/global youngsModulus peratomtype 0.45e6 0.45e6 0.45e6 0.45e6 0.45e6 0.45e6
...
fix 		m4 all property/global coefficientFriction peratomtypepair 6 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9 0.9
# 
...
variable        r5_final equal 6.5     # 13.0 µm diameter / 2
...
# fix dist1 all particledistribution/discrete/numberbased 49979693 5 pts1 0.9 pts2 0.97 pts3 0.58 pts4 0.94 pts5 0.01
...
fix piston_force all ave/time 1 1 1000 f_piston_m[1] f_piston_m[2] f_piston_m[3] file post/piston_force_default.txt
...
run		1
dump		dmp all custom/vtk 25000 post/H-B_packing_*.vtk id type type x y z ix iy iz vx vy vz fx fy fz omegax omegay omegaz radius 
...
# fix chk all check/timestep/gran 100 0.9 error
...
timestep	1.0e-4
variable startZ    equal ${zpoint}
variable endZ      equal 68.85
variable dz        equal ${startZ}-${endZ}
variable cvel      equal 0.15e-2
variable rvel      equal -1*${cvel}
variable ts_move   equal (${dz}/${cvel})/(1e-4)
